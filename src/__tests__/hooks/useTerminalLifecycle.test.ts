...
describe("useTerminalLifecycle", () => {
  ...
  describe("clearTerminal", () => {
    it("calls clear on active terminal ref", () => {
      ...
      terminalsStore.setActive(id);
      terminalsStore.update(id, { ref: { clear: mockClear, fit: vi.fn(), write: vi.fn(), writeln: vi.fn(), input: vi.fn(), focus: vi.fn(), getSessionId: vi.fn(), getSelection: vi.fn(() => ""), openSearch: vi.fn(), closeSearch: vi.fn(), searchBuffer: vi.fn(() => []), scrollToLine: vi.fn(), scrollToTop: vi.fn(), scrollToBottom: vi.fn(), scrollPages: vi.fn(), getBufferLines: vi.fn(() => []) } });
  ...
  describe("pasteToTerminal", () => {
    it("pastes clipboard text to active terminal", async () => {
      ...
      terminalsStore.update(id, {
        ref: { write: mockWrite, clear: vi.fn(), fit: vi.fn(), writeln: vi.fn(), input: vi.fn(), focus: vi.fn(), getSessionId: vi.fn(), getSelection: vi.fn(() => ""), openSearch: vi.fn(), closeSearch: vi.fn(), searchBuffer: vi.fn(() => []), scrollToLine: vi.fn(), scrollToTop: vi.fn(), scrollToBottom: vi.fn(), scrollPages: vi.fn(), getBufferLines: vi.fn(() => []) },
      });
