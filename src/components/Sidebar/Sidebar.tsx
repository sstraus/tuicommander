...
const BranchIcon: Component<{ isMain: boolean; hasQuestion?: boolean }> = (props) => (
  <span class={`branch-icon ${props.hasQuestion ? "question" : props.isMain ? "main" : "feature"}`}>
    {props.hasQuestion ? "?" : props.isMain
      ? <svg viewBox="0 0 16 16" width="13" height="13" fill="currentColor"><path d="M9 2.2V6.3l3.5-2a1 1 0 1 1 1 1.7L10 8l3.5 2a1 1 0 1 1-1 1.7L9 9.7v4.1a1 1 0 1 1-2 0V9.7l-3.5 2a1 1 0 1 1-1-1.7L6 8 2.5 6a1 1 0 0 1 1-1.7L7 6.3V2.2a1 1 0 0 1 2 0z"/></svg>
