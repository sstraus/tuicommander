...
// canMergePr and RemoteOnlyPrPopover moved to ./RemoteOnlyPrPopover.tsx
import { RemoteOnlyPrPopover } from "./RemoteOnlyPrPopover";
export { canMergePr, RemoteOnlyPrPopover } from "./RemoteOnlyPrPopover";
