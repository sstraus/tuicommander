            ...
            {(tab) => (
              ...
              >
                ...
                <Show when={tab.type === "terminal"}>
                  <span
                    class={`pane-tab-promote ${globalWorkspaceStore.isPromoted(tab.id) ? "pane-tab-promoted" : ""}`}
                    title={globalWorkspaceStore.isPromoted(tab.id) ? "Remove from Global Workspace" : "Promote to Global Workspace"}
                    onClick={(e) => {
                      e.stopPropagation();
                      if (globalWorkspaceStore.isPromoted(tab.id)) {
                        globalWorkspaceStore.unpromote(tab.id);
                      } else {
                        globalWorkspaceStore.promote(tab.id);
                      }
                    }}
                  >
