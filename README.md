...
TUICommander auto-detects **10 AI coding agents** (Claude Code, Codex CLI, Aider, Gemini CLI, Amp, Jules, Cursor Agent, OpenCode, Warp Oz, ONA) and understands what they're doing:
