#!/usr/bin/env node
// Cross-platform sidecar builder for tuic-mcp-bridge.
...
const binName = `tuic-mcp-bridge${ext}`;
const sidecarName = `tuic-mcp-bridge-${target}${ext}`;
...
execSync("cargo build --release --bin tuic-mcp-bridge", {
